...
<div class="container-fluid"> 
  <div class="row">
    <div class="col-sm-1" style="background-color:white;">
      <input type=hidden name="cse" value="CSCI665"><p>CSCI 665</p>
    </div>
    <div class="col-sm-2" style="background-color:white;">
  <input type="hidden" name="se1" value="SoftwareEngineering"><a href="#demo1" data-toggle="collapse">Software Engineering</a></label>
  ...
  <div class="container-fluid"> 
    <div class="row">
      <div class="col-sm-1" style="background-color:white;">
        <input type=hidden name="ccg" value="CSCI670"> <p>CSCI 670</p>
      </div>
      <div class="col-sm-2" style="background-color:white;">
    <input type="hidden" name="cg1" value="ComputerGraphics"><a href="#demo2" data-toggle="collapse">Computer Graphics</a>
  ...
  <div class="container-fluid"> 
    <div class="row">
      <div class="col-sm-1" style="background-color:white;">
        <input type=hidden name="ccn" value="CSCI690"><p>CSCI 690</p>
      </div>
      <div class="col-sm-2" style="background-color:white;">
    <input type="hidden" name="cn1" value="ComputerNetworks"><a href="#demo3" data-toggle="collapse">Computer Networks</a>
